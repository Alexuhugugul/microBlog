import { actionAddTaskForYears } from '../controller/createNewTaskForYears';
import replaceUrl from '../utils/replaceUrl';

const url = window.location.search;
const datePage = replaceUrl(url, /[?page=,.html]/g);

export default class ViewCreatorTasksForYears {

    createTaskForYears(tasks, keys) {
